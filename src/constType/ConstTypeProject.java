...
public class ConstTypeProject {
    ...
    public static final String PATH_CHAIR_DETAILS_DEFAULT = PATH_DEFAULT + PATH_CHAIR_PAKE_DETAILS_DEFAULT + "chairDetails";
    public static final String PATH_CHAIR_PRICE_DEFAULT = PATH_DEFAULT + PATH_CHAIR_PAKE_PRICE_DEFAULT + "chairPrice";
